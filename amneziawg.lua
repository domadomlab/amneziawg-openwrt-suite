...
function action_data()
    ...
    local handshake = tonumber(util.exec("awg-new show " .. iface .. " latest-handshakes 2>/dev/null | awk '{print $NF}'") or "0")
